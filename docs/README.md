...
bash scripts/nuclear-wipe.sh # Full-system reset helper (EXTREME CAUTION)
...
├── tests/ # Test suites
├── examples_and_samples/ # Demonstration and archive content (473MB)
│ ├── demo/ # Demo/archive materials (291MB)
