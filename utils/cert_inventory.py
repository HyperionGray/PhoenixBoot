...
# Ensure log path exists before creating FileHandler
LOG_DIR = "/var/log/phoenixguard"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'{LOG_DIR}/cert_inventory.log'),
...
class PhoenixGuardCertInventory:
    ...
    def run_command(self, cmd: List[str], check: bool = True) -> subprocess.CompletedProcess:
        """Run a command safely using argument lists (no shell)."""
        logger.info("Running command: %s", " ".join(shlex.quote(part) for part in cmd))
        try:
